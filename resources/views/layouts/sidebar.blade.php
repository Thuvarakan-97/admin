                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                <a href="{{ route('students.index') }}" class="waves-effect {{ request()->is("students") || request()->is("students/*") ? "mm active" : "" }}">
                                    <i class="ti-user"></i><span> Students </span>
                                </a>
                            </li>

                            <li>
                                <a href="{{ route('departments.index') }}" class="waves-effect {{ request()->is("departments") || request()->is("department/*") ? "mm active" : "" }}">
                                    <i class="ti-home"></i><span> Departments </span>
                                </a>
                            </li>
